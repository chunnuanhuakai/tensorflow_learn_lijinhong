# -*- coding: utf-8 -*-
"""
Created on Wed Sep  5 20:31:53 2018
...
#learning_rate = tf.train.exponential_decay(learning_rate=learning_rate_init, 
#                                           global_step=global_step,decay_steps = 10,decay_rate = 0.9)
...
###  修改mnist 交叉熵为  sparse_softmax_cross_entropy_with_logits

import tensorflow as tf
from tensorflow.examples.tutorials.mnist import input_data
import pylab

mnist = input_data.read_data_sets("E:/liuhongbing/python/data/MNIST_data/")
...
cost = tf.reduce_mean(tf.nn.sparse_softmax_cross_entropy_with_logits(logits = nodevalue, labels = y))
learning_rate = 0.01
...
# --------------create model end ---------------------------
# --------------test model --------------------------------
correct_predict = tf.equal(tf.argmax(pred, 1), y)
accuracy = tf.reduce_mean(tf.cast(correct_predict, tf.float32))
#--------------end test model -----------------------------

saver = tf.train.Saver(max_to_keep=2)
savedir = './log_chapt6/mnist_model.ckpt'
