...
l1_reconstruction = noise_l1_autodecoder(l1_out, weights, biases, drop_keep_prob)
...
savedir = "C:/Users/zbj/tensorflow_learn_lijinhong/tensorflow_learn/tensorflow_learn_lijinhong/chapter10/log"
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        for i in range(num_batch):
            ...
            feeds = {X: batch_xs_noisy, Y: batch_xs, drop_keep_prob: 0.5}
    ...
    encode_decode = sess.run(
        l1_reconstruction, feed_dict={X: test_noisy, drop_keep_prob: 1.})
...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        for i in range(num_batch):
            batch_xs, batch_ys = mnist.train.next_batch(batch_size)
            l1_h = sess.run(l1_out, feed_dict={X: batch_xs, Y: batch_xs, drop_keep_prob: 1.})
    ...
    out1vec = sess.run(l1_out, feed_dict={X: testvec,Y: testvec, drop_keep_prob: 1.})
